...
In conventional abliteration, simple vector subtraction is used to determine the direction between helpful and harmful responses.

I have added an additional script to instead use Spherical Linear Interpolation (SLERP) to maintain constant angular velocity and hopefully better preserve semantic coherence. This script was tested on an RTX 4060 Ti 16GB, using CUDA 12.6, Torch 2.6, and Python 3.11.9. 
